  ...
  render() {
    ...
    return (
      <div className="deleteModal">
        <h4 className="bg-dark text-white">Modifier un contact</h4>
        ...
        <div>
          <button onClick={(e) => confirmModifyContact(e)}>Confirmer</button>
          <button onClick={(e) => abortModify(e)}>Annuler</button>
        </div>
      </div>
    );
  }
